...
namespace Microsoft.Research.DynamicDataDisplay
{
	...
	public class Viewport2D : Canvas, IViewport2D, IPlotterElement
	{
		...
		{
		    var oldValue = this.AutoFitToView;
		    this.AutoFitToView = true;
			ClearValue(VisibleProperty);
			CoerceValue(VisibleProperty);
            this.AutoFitToView = oldValue;
		}
		...
		{
		    if ((d as Viewport2D).VisibleChanged != null)
		        (d as Viewport2D).VisibleChanged(d, null);
		}
